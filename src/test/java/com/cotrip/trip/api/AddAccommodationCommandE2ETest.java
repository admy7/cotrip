...
public class AddAccommodationCommandE2ETest {
  ...
  void shouldAddAccommodationToTrip() throws Exception {
    var dto =
        new AddAccommodationDTO(
            "The Emory",
            new AddPlaceDTO("Old Barrack Yard", "London", "SW1X 7NP", "United Kingdom"),
            "2025-01-01T08:00:00",
            "2025-01-03T08:00:00",
            new AddPriceDTO("EUR", 4400));

    mockMvc
        .perform(
            MockMvcRequestBuilders.post(String.format("/trips/%s/add-accommodation", tripId))
